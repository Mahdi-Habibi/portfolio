...
export default function About() {
    return (
        <div
            ...
            <p className="mb-3 text-gray-500 dark:text-gray-400 text-justify">Track work across the
            ...
            <p className="mb-3 text-gray-500 dark:text-gray-400 text-justify">Deliver great service experiences
